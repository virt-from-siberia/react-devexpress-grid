...
export const App = () => {
  ...
  const tableColumnExtensions = [
    ...
    { columnName: "body", width: 150, wordWrapEnabled: true },
    { columnName: "title", width: 100, wordWrapEnabled: false },
    { columnName: "userId", width: 100, align: "right" },
  ];

  return (
    <div className="card">
      {/* @ts-ignore */}
      <Grid rows={posts} columns={gridColumns}>
        <SortingState
          defaultSorting={[
